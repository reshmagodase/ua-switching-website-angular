...
export function buildMonth(calendar, date, state, i18n) {
    ...
    for (var week = 0; week < calendar.getWeeksPerMonth(); week++) {
        ...
        month.weeks.push({ number: calendar.getWeekNumber(days.map(function (day) { return NgbDate.from(day.date); }), firstDayOfWeek), days: days, collapsed: collapsed });
    }
    return month;
}
