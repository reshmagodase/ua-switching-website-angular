...
export class SwitchService {
  ...
  getSupplyAddresses(request) {
    this.spinner.show();
    return this.http
      .post(this.baseUrl + "/api/getSupplyAddresses", request)
      .pipe(
        map(data => data),
  ...
  getElectricPricesList(request) {
    this.spinner.show();
    return this.http
      .post(this.baseUrl + "/api/getElectricPrices", request)
      .pipe(
        map(data => data),
        catchError((error: any) => throwError(error))
      );
  ...
  checkEmail(request) {
    this.spinner.show();
    return this.http
      .get(this.baseUrl + "/api/checkEmail?email=" + request.email)
      .pipe(
        map(data => data),
        catchError((error: any) => throwError(error))
      );
  ...
  verifyBankAccountNumber(request) {
    this.spinner.show();
    return this.http
      .post(this.baseUrl + "/api/verifyBankAccountNumber", request)
      .pipe(
        map(data => data),
        catchError((error: any) => throwError(error))
      );
  ...
  updateSteps(request) {
    this.spinner.show();
    return this.http
      .put(this.baseUrl + "/api/steps/" + request.stepsId, request)
      .pipe(
        map(data => data),
        catchError((error: any) => throwError(error))
      );
  ...
  updateUser(request) {
    this.spinner.show();
    return this.http
      .put(this.baseUrl + "/api/users/" + request.userId, request)
      .pipe(
        map(data => data),
        catchError((error: any) => throwError(error))
      );
